...
export const UserActivityResponse = {
  ...
  properties: {
    ...
    current_workspace: { type: 'string', nullable: true },
    currentWorkspace: { type: 'string', nullable: true },
...
UserActivityResponse.example = {
  ...
  profileImage: null,
  avatar: null,
  current_job_title: 'Export Manager',
  currentJobTitle: 'Export Manager',
  current_workspace: 'TradeBridge',
  currentWorkspace: 'TradeBridge',
  follower_count: 18,
  followerCount: 18,
  following_count: 9,
  followingCount: 9,
  profile: { username: 'janedoe', displayName: 'Jane Doe', avatar: null, profile_image: null, profileImage: null, bio: 'Exporter and product designer', location: 'Lagos', current_job_title: 'Export Manager', currentJobTitle: 'Export Manager', current_workspace: 'TradeBridge', currentWorkspace: 'TradeBridge', follower_count: 18, followerCount: 18, following_count: 9, followingCount: 9 },
...
export const PostResponse = {
  ...
  properties: {
    ...
    parent: {
      type: ['object', 'null'],
      description: 'Full original post for a shared post; null for an ordinary post. The nested parent is always null.',
      properties: {
        id: { type: 'string' },
        user_id: { type: 'string' },
        ...
        community: { type: ['object', 'null'], additionalProperties: true },
...
export const UserProfileBody = {
  ...
  properties: {
    ...
    github: { type: 'string' },
    displayTitle: { type: 'string', description: 'Profile display title shown separately from current job title.' },
    display_title: { type: 'string', description: 'Snake-case profile display title shown separately from current job title.' },
  ...
  example: {
    ...
    displayTitle: 'Open to Export Partnerships',
...
export const UserProfileResponse = {
  ...
  properties: {
    ...
    linkedin: { type: 'string' },
    github: { type: 'string' },
    displayTitle: { type: ['string','null'], description: 'Profile display title shown separately from current job title.' },
    display_title: { type: ['string','null'], description: 'Snake-case profile display title shown separately from current job title.' },
    currentJobTitle: { type: ['string','null'] },
    current_job_title: { type: ['string','null'] },
...
UserProfileResponse.example = {
  ...
  github: 'https://github.com/tech',
  displayTitle: 'Open to Export Partnerships',
  display_title: 'Open to Export Partnerships',
  currentJobTitle: 'Backend Engineer',
