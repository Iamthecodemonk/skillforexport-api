...
export default async function registerRoutes(fastify, deps) {
  ...
  fastify.get('/report-reasons', { schema: { operationId: 'legacyListReportReasons', tags: ['Reports'], description: 'Legacy report reasons endpoint', response: { 200: dataResponse({ type: 'array', items: { type: 'object', properties: { id: { type: 'string' }, description: { type: 'string' } } } }) } } }, handler('reportReasons'));
