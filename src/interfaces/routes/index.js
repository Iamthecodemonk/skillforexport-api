...
export default async function registerRoutes(fastify, deps) {
  ...
  const reportedTargetSchema = {
    type: 'object',
    properties: {
      id: { type: 'string', description: 'Alias of targetId. Use this for moderation actions.' },
      targetType: { type: 'string', enum: ['post', 'comment', 'question', 'answer', 'page', 'job'] },
      targetId: { type: 'string' },
      primaryReportId: { type: ['string','null'], description: 'One report id attached to this target.' },
  ...
  const moderationActionResponse = dataResponse({
    ...
    properties: {
      targetType: { type: 'string', enum: ['post', 'comment', 'question', 'answer', 'page', 'job'] },
      targetId: { type: 'string' },
      requestedId: { type: 'string', description: 'The id passed in the URL/body. This can be a target id or a report id.' },
  ...
  fastify.get('/admin/freelance-jobs', {
    preHandler: deps && deps.authRequired ? deps.authRequired : undefined,
    schema: { operationId: 'adminListFreelanceJobs', tags: ['Admin', 'Freelance Jobs'], description: 'Admin list of all freelance jobs, including pending, approved, suspended, deleted, closed, and archived jobs. Defaults to per_page=100. Omit status or send status=all for all freelance jobs; status=pending is accepted as pending_review.', querystring: freelanceJobsQuery, response: { 200: schemas.FreelanceJobPaginatedResponse, 401: schemas.AuthErrorResponse, 403: schemas.GenericErrorResponse } }
  ...
  fastify.post('/freelance-jobs/:id/applications', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'applyToFreelanceJob', tags: ['Freelance Jobs'], description: 'Apply to freelance job. The authenticated user must already have a freelancer profile.', params: idParam(), body: schemas.FreelanceApplicationBody, response: { 201: dataResponse(schemas.FreelanceApplicationResponse), 401: schemas.AuthErrorResponse, 404: schemas.GenericErrorResponse, 422: schemas.GenericErrorResponse } } }, handler('applyToFreelanceJob'));
  ...
  fastify.get('/advert-locations/all', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'listAllAdvertLocations', tags: ['Adverts'], description: 'Admin list of all advert location options, including suspended and deleted options.', querystring: { type: 'object', properties: listQueryBase }, response: { 200: schemas.AdvertLocationPaginatedResponse, 401: schemas.AuthErrorResponse, 403: schemas.GenericErrorResponse } } }, handler('listAllAdvertLocations'));
  ...
  fastify.get('/advert-sites/all', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'listAllAdvertSites', tags: ['Adverts'], description: 'Admin list of all advert site options, including suspended and deleted options.', querystring: { type: 'object', properties: listQueryBase }, response: { 200: schemas.AdvertSitePaginatedResponse, 401: schemas.AuthErrorResponse, 403: schemas.GenericErrorResponse } } }, handler('listAllAdvertSites'));
  ...
  fastify.get('/advert-sizes', { schema: { operationId: 'listAdvertSizes', tags: ['Adverts'], description: 'List active advert sizes. Suspended/deleted sizes are excluded from active selection lists.', querystring: { type: 'object', properties: listQueryBase }, response: { 200: schemas.AdvertSizePaginatedResponse || schemas.AdvertSitePaginatedResponse } } }, handler('listAdvertSizes'));
  fastify.get('/advert-sizes/all', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'listAllAdvertSizes', tags: ['Adverts'], description: 'Admin list of all advert sizes, including suspended and deleted sizes.', querystring: { type: 'object', properties: listQueryBase }, response: { 200: schemas.AdvertSizePaginatedResponse || schemas.AdvertSitePaginatedResponse, 401: schemas.AuthErrorResponse, 403: schemas.GenericErrorResponse } } }, handler('listAllAdvertSizes'));
  fastify.post('/advert-sizes', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'createAdvertSize', tags: ['Adverts'], description: 'Create an advert size option.', body: schemas.AdvertSizeCreateBody || schemas.AdvertOptionCreateBody, response: { 201: dataResponse(schemas.AdvertSizeResponse || schemas.AdvertSiteResponse) } } }, handler('createAdvertSize'));
  fastify.patch('/advert-sizes/:id', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'updateAdvertSize', tags: ['Adverts'], description: 'Update an advert size option.', params: idParam(), body: { ...(schemas.AdvertSizeCreateBody || schemas.AdvertOptionCreateBody), required: [] }, response: { 200: dataResponse(schemas.AdvertSizeResponse || schemas.AdvertSiteResponse) } } }, handler('updateAdvertSize'));
  fastify.patch('/advert-sizes/:id/status', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'updateAdvertSizeStatus', tags: ['Adverts'], description: 'Suspend, delete, or unsuspend an advert size option.', params: idParam(), body: schemas.StatusUpdateBody, response: { 200: dataResponse(schemas.AdvertSizeResponse || schemas.AdvertSiteResponse) } } }, handler('updateAdvertSizeStatus'));
  fastify.delete('/advert-sizes/:id', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'deleteAdvertSize', tags: ['Adverts'], description: 'Soft-delete an advert size option by setting status to `deleted`.', params: idParam(), response: { 200: dataResponse(schemas.AdvertSizeResponse || schemas.AdvertSiteResponse) } } }, async (req, reply) => {
    req.body = { status: 'deleted' };
    return handler('updateAdvertSizeStatus')(req, reply);
  });
  ...
  fastify.get('/privacy-policy', { schema: { operationId: 'getPrivacyPolicyDocument', tags: ['Legal'], description: 'Return the published Privacy Policy document.', response: { 200: dataResponse(schemas.LegalDocumentResponse), 404: schemas.GenericErrorResponse } } }, async (req, reply) => { req.params = { slug: 'privacy-policy' }; return handler('getLegalDocument')(req, reply); });
  fastify.get('/cookie-policy', { schema: { operationId: 'getCookiePolicyDocument', tags: ['Legal'], description: 'Return the published Cookie Policy document.', response: { 200: dataResponse(schemas.LegalDocumentResponse), 404: schemas.GenericErrorResponse } } }, async (req, reply) => { req.params = { slug: 'cookie-policy' }; return handler('getLegalDocument')(req, reply); });
  fastify.get('/community-rules', { schema: { operationId: 'getCommunityRulesDocument', tags: ['Legal'], description: 'Return the published Community Rules document.', response: { 200: dataResponse(schemas.LegalDocumentResponse), 404: schemas.GenericErrorResponse } } }, async (req, reply) => { req.params = { slug: 'community-rules' }; return handler('getLegalDocument')(req, reply); });
  fastify.get('/terms', { schema: { operationId: 'getTermsDocument', tags: ['Legal'], description: 'Return the published Terms document.', response: { 200: dataResponse(schemas.LegalDocumentResponse), 404: schemas.GenericErrorResponse } } }, async (req, reply) => { req.params = { slug: 'terms' }; return handler('getLegalDocument')(req, reply); });
  fastify.get('/admin/legal-documents', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'adminListLegalDocuments', tags: ['Admin', 'Legal'], description: 'Admin list of all legal/static documents including draft and archived records.', response: { 200: dataResponse({ type: 'array', items: schemas.LegalDocumentResponse }), 401: schemas.AuthErrorResponse, 403: schemas.GenericErrorResponse } } }, handler('adminListLegalDocuments'));
  fastify.post('/admin/legal-documents', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'adminCreateLegalDocument', tags: ['Admin', 'Legal'], description: 'Admin create a legal/static document.', body: schemas.LegalDocumentCreateBody, response: { 201: dataResponse(schemas.LegalDocumentResponse), 401: schemas.AuthErrorResponse, 403: schemas.GenericErrorResponse, 422: schemas.GenericErrorResponse } } }, handler('adminCreateLegalDocument'));
  fastify.patch('/admin/legal-documents/:id', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'adminUpdateLegalDocument', tags: ['Admin', 'Legal'], description: 'Admin update a legal/static document.', params: idParam(), body: schemas.LegalDocumentUpdateBody, response: { 200: dataResponse(schemas.LegalDocumentResponse), 401: schemas.AuthErrorResponse, 403: schemas.GenericErrorResponse, 404: schemas.GenericErrorResponse, 422: schemas.GenericErrorResponse } } }, handler('adminUpdateLegalDocument'));
  fastify.delete('/admin/legal-documents/:id', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'adminDeleteLegalDocument', tags: ['Admin', 'Legal'], description: 'Admin delete a legal/static document.', params: idParam(), response: { 200: dataResponse({ type: 'object', properties: { id: { type: 'string' } } }), 401: schemas.AuthErrorResponse, 403: schemas.GenericErrorResponse, 404: schemas.GenericErrorResponse } } }, handler('adminDeleteLegalDocument'));
  ...
  fastify.patch('/user/privacy', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'legacyPatchPrivacy', tags: ['Users'], description: 'Partially update authenticated user privacy settings. Response matches PUT /user/privacy.', body: schemas.UserPrivacyBody, response: { 200: schemas.UserPrivacyUpdateResponse, 401: schemas.AuthErrorResponse } } }, handler('updatePrivacy'));
  fastify.get('/user/settings', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'legacyGetSettings', tags: ['Users'], description: 'Get authenticated user settings object.', response: { 200: schemas.UserSettingsResponse, 401: schemas.AuthErrorResponse } } }, handler('getSettings'));
  fastify.put('/user/settings', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'legacyUpdateSettings', tags: ['Users'], description: 'Update legacy settings. Request/response matches API contract.', body: schemas.UserSettingsBody, response: { 200: schemas.UserSettingsResponse, 401: schemas.AuthErrorResponse } } }, handler('updateSettings'));
  fastify.patch('/user/settings', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'legacyPatchSettings', tags: ['Users'], description: 'Partially update authenticated user settings. Response matches PUT /user/settings.', body: schemas.UserSettingsBody, response: { 200: schemas.UserSettingsResponse, 401: schemas.AuthErrorResponse } } }, handler('updateSettings'));
  ...
  fastify.get('/notifications/unread-count', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'unreadNotificationCount', tags: ['Notifications'], description: 'Unread notification count', response: { 200: { type: 'object', properties: { success: { type: 'boolean' }, count: { type: 'number' }, data: { type: 'object', properties: { count: { type: 'number' } } } } } } } }, handler('unreadNotificationCount'));
  ...
  fastify.get('/report-reasons', { schema: { operationId: 'legacyListReportReasons', tags: ['Reports'], description: 'Legacy report reasons endpoint', response: { 200: dataResponse({ type: 'array', items: { type: 'object', properties: { id: { type: 'string', description: 'Machine-friendly reason key' }, description: { type: 'string', description: 'Human-readable reason description' } } } }) } } }, handler('reportReasons'));
  ...
  fastify.post('/questions/:id/report', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'reportQuestion', tags: ['Questions', 'Reports'], description: 'Report a question for moderation.', params: idParam(), body: genericReportBody, response: { 201: genericSuccess, 422: schemas.GenericErrorResponse } } }, handler('reportQuestion'));
  fastify.post('/answers/:id/report', { preHandler: deps && deps.authRequired ? deps.authRequired : undefined, schema: { operationId: 'reportAnswer', tags: ['Answers', 'Reports'], description: 'Report an answer for moderation.', params: idParam(), body: genericReportBody, response: { 201: genericSuccess, 422: schemas.GenericErrorResponse } } }, handler('reportAnswer'));
  ...
  fastify.get('/questions/:id', {
    schema: {
      ...
      tags: ['Questions'],
      description: 'Get a single question by id with user details, community details when available, answer aggregates, and answers by default. Set `includeAnswers=false` to omit answers.',
