...
export default class PostUseCase {
  ...
  async ListPosts({ limit = 20, offset = 0, lastCreatedAt = null, lastId = null, userId = null, communityId = null, communitySlug = null, publicOnly = false, search = null, sortField = null, sortDirection = null, includeHidden = false, status = null, includeTotal = false } = {}) {
    return this.postRepository.list({ limit, offset, lastCreatedAt, lastId, userId, communityId, communitySlug, publicOnly, search, sortField, sortDirection, includeHidden, status, includeTotal });
  }
